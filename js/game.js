...
function handleComplete() {
    ...
    counter = new createjs.Text(0, "86px 'Droppy Bird'", "#ffffff");
    counterOutline = new createjs.Text(0, "86px 'Droppy Bird'", "#000000");
...
function goShare() {
    ...
    window.open("https://twitter.com/share?url=https%3A%2F%2Fkariera.droptica.pl%2Fdroppy&text=I scored " + countText + " on Droptica's Droppy Bird.");
}
